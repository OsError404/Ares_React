  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Sedes y Salas</h1>
        <button
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {locations.map((location) => (
              <tr key={location.id}>
                ...
                <td className="whitespace-nowrap px-6 py-4">{location.address}</td>
                <td className="whitespace-nowrap px-6 py-4">{location.city}</td>
          ...
          <>
            ...
            >
              <div className="mb-4 flex items-center justify-between">
                <h2 className="text-xl font-semibold">Nueva Sede</h2>
                <button
                  onClick={() => setIsFormOpen(false)}
